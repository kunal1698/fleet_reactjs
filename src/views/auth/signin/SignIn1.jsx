...
// assets
import FlitLogo from '../../../assets/images/FlitlogoNew.png';
      ...
      <div className="auth-wrapper">
        <div className="auth-content">
          ...
          <Card className="borderless text-center">
            <Card.Body>
              <img width={'50%'} src={FlitLogo} alt="" className="img-fluid mb-4" />
              <h6 style={{ marginBottom: '20px', color: '#012F81', fontSize: '11px' }}>Powered By V5 Logistics & WareHousing Pvt Ltd</h6>
              <JWTLogin />
